...
(function() {
  var ingredientList, moveIngredient;

  ingredientList = [];

  moveIngredient = function(direction, id, displayName) {
    if (direction === 1) {
    ...
    return $.ajax('search_from_ingredients', {
      type: 'GET',
      data: {
  ...
  $(function() {
    return $("a[data-direction]").click(function(e) {
      var ingredientId, ingredientName, moveDirection;
      moveDirection = $(this).data("direction");
      ingredientId = $(this).data("ingredient-id");
      ingredientName = $(this).data("display-name");
      return moveIngredient(moveDirection, ingredientId, ingredientName);
    });
  });

  $(function() {
    return $('#recipe_search').typeahead({
      name: "recipe",
